...
function setFocusedRef(r, param) {
  param[/* state */1][/* focusedPromptRef */4][0] = (r == null) ? /* None */0 : [r];
  return /* () */0;
}
...
function make() {
  ...
  return /* record */[
          ...
          /* didUpdate */(function (param) {
              return scrollIntoView(param[/* newSelf */1][/* state */1][/* focusedPromptRef */4][0]);
            }),
          ...
          /* render */(function (self) {
              return React.createElement("div", {
                          className: container
                        }, ReasonReact.element(/* None */0, /* None */0, TitleBar$Portfolio.make(self[/* state */1][/* shell */0], /* array */[])), React.createElement("div", {
                              className: content
                            }, React.createElement("p", undefined, showHelp(self[/* state */1][/* history */2])), $$Array.of_list(List.rev(List.map((function (param) {
                                          ...
                                          }), self[/* state */1][/* history */2]))), React.createElement("label", {
                                  onKeyDown: (function ($$event) {
                                      ...
                                      autoFocus: true,
                                      value: self[/* state */1][/* input */1],
                                      onBlur: (function () {
                                          return Curry._1(self[/* send */3], /* Focus */0);
                                        }),
                                      onChange: (function (evt) {
                                          var element = evt;
                                          var self$1 = self;
                                          var text = Utils$Portfolio.getText(element);
                                          return Curry._1(self$1[/* send */3], /* Change */Block.__(0, [text]));
                                        })
                                    }))));
            }),
          ...
          /* reducer */(function (action, state) {
              if (typeof action === "number") {
                return /* SideEffects */Block.__(1, [(function (param) {
                              return focusElement(param[/* state */1][/* focusedPromptRef */4][0]);
                            })]);
              } else if (action.tag) {
                var state$1 = state;
                var key = action[0];
