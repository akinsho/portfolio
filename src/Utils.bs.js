...
var FontawesomeFreeBrands = require("@fortawesome/fontawesome-free-brands");

function str(prim) {
  return prim;
}

function getElement(prim) {
  return prim;
}
...
Fontawesome.library.add(FontawesomeFreeBrands.default);

function make(icon, size, className, children) {
...
function make$1(settings, children) {
  return ReasonReact.wrapJsForReason(ReactSlick.default, {
              ...
              slidesToScroll: settings[/* slidesToScroll */4]
            }, children);
}

var Slick = /* module */[/* make */make$1];
